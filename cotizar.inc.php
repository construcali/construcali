...
<div class="wrapper">
   ...
   <!--=== Search Block Version 2 ===-->
    ...
    <div class="container content">
            ...
            <div class="col-md-9">
                ...
                <div class="tab-v1">
                    <ul class="nav nav-tabs">
                        <li class="active" ><a href="#categoriasMateriales" data-toggle="tab">Categorias</a></li>
                        <li id="menuMateriales"><a href="#home" data-toggle="tab">Cotizar Materiales</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade in" id="categoriasMateriales">
                            ...
                            <?php
                            if (isset($alerta)){echo '<h2>'.$alerta.'</h2>';}
                            ?>
                            </div>
                                <div class="col-md-12">
        ...
        <div class="col-md-3">
                <!-- Tabs Widget -->
                <div class="headline headline-md"><h2>Bases de Datos</h2></div>
