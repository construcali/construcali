    ...
    <div class="breadcrumbs">
        <div class="container">
            ...
            <ul class="pull-right breadcrumb">
                ...
                <li class="active"><a href="foros.php?content=nuevoforo">Publicar Foro</a></li>
            </ul>
        </div>
    </div>
<!--=== End Breadcrumbs ===-->
                            ...
                            <div class="row">
                                ...
                                <?php
                                    foreach ($categorias as $key => $value) {
                                         echo "<li><a href=\"portafolios.php?content=estoslibrospdf&catid=$key\"><i class=\"fa fa-tags\"></i>$value</a></li>";
                                     } 
                                ?>      
                                </ul>
                            </div>                    
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php 
                                        ...
                                        echo "<a href=\"$url\" target=\"_blank\" class=\"btn btn-md u-btn-indigo\">Descargar</a>";}
                                        else{
                                        ?>
                                        <a href="index.php?content=nuevaempresa">Vincule su Empresa</a>
                                        <?php
                                        }
                                        ?>
                                    </td>
                        ...
                        <div class="text-center">
                            ...
                            <?php
                             if ($thispage > 1)
                                {
                                    $page = $thispage - 1 ;
                                    $prevpage = "<li class=\"active\"><a href=\"portafolios.php?content=descargas&page=$page\">Anterior</a></li>";
                                }
                                else
                                {
                            ...
                            if ($totpages >1)
                                {
                                    ...
                                    for($page = 1; $page <= $totpages; $page++)
                                    {
                                        ...
                                        {
                                            $bar .= "<li><a href=\"portafolios.php?content=descargas&page=$page\">$page</a></li>";
                                        }
                                    }
                                }
                            ...
                            if ($thispage < $totpages)
                             {
                                $page = $thispage + 1;
                                $nextpage = "<li><a href=\"portafolios.php?content=descargas&page=$page\">Proxima</a></li>"; 
                             }else
                             {
