        ...
        <div class="row job-content">
            <div class="col-md-9">
                ...
                <div class="inner-results ultimos_servicios">
                    <?php echo "<h3><a href=\"anuncios.php?content=unservicio&id=$productoid\">$titulo</a></h3>"; ?>
                    ...
                    echo "<img src=\"showservicios.php?id=$productoid\" width=\"550\" height=\"300\" />";
                    echo "</a>";
                     ?>
                        <div class="overflow-a">
                            ...
                            <ul class="list-inline down-ul">
                                ...
                                <li class="resServicio"><i class="fa fa-reply"></i><?php echo "<a href=\"anuncios.php?content=unservicio&id=$productoid\">Responder</a>"; ?></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="text-left">
                    ...
                    {
                        $page = $thispage - 1 ;
                        $prevpage = "<li><a href=\"anuncios.php?content=servicios&sector=$sector&page=$page\">Atras</a></li";
                    }
                    else
                    {
                ...
                if ($totpages >1)
                    {
                        ...
                        for($page = 1; $page <= $totpages; $page++)
                        {
                            ...
                            {
                                $bar .= "<li><a href=\"anuncios.php?content=servicios&sector=$sector&page=$page\">$page</a></li>";
                            }
                        }
                    }
                ...
                if ($thispage < $totpages)
                 {
                    $page = $thispage + 1;
                    $nextpage = "<li><a href=\"anuncios.php?content=servicios&sector=$sector&page=$page\">Adelante</a></li>"; 
                 }else
                 {
