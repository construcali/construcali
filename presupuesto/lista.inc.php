                    ...
                    <div class="tab-v1">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade in active" id="insumosMateriales">
                                ...
                                echo "<form action=\"presupuesto.php?content=lista\" method=\"post\" id=\"nuevoForo\">\n";
                                ...
                                foreach ($materiales as $material){
                                    ...
                                    echo "<tr>";
                                        ...
                                        echo "<tr><td></td><td><button type=\"submit\" name=\"boton\" value=\"cotizar\" class=\"btn-u btn-u-green\">Cotizar con Proveedores</button></td><td><button type=\"submit\" class=\"btn-u btn-u-blue\" name=\"boton\" value=\"editar\">Editar</button></td><td>Total</td><td>$".number_format($_SESSION['valor_obra'], 2, '.', ',')."</td></tr>";
                                    echo "</tbody>";
                                    echo "</table>\n";
                                    echo "</form>";
                                            ...
                                            <table class="table table-striped invoice-table">
                                                <tbody>
                                                    ...
                                                    <?php
                                                        ...
                                                        echo "<td><a href=\"presupuesto.php?content=articulos&id=$catid\">$seccion</a></td>";
                                                        if ($i==2 || $i==5 || $i==8 || $i==11){
                                                            echo "</tr><tr>";
                                                        }
                                                        $i=$i+1;
                ...
                <div class="tab-v2 margin-bottom-40">
                    ...
                    <div class="tab-content">
                        <div id="home-1" class="tab-pane active">
                            <form action="presupuesto.php?content=articulos" method="post" class="sky-form" id="listaClase">
                                <select name="id" class="form-control" id="listaClaseId">
                                    <?php
