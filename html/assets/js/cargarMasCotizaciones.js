...
function setearPaginaActual($page){
    console.log($page);
    $('#masCotizaciones').attr('data-pagina',$page);
}
...
function masAnuncios(){
    ...
    $('#spinner').show();
    $('#masCotizaciones').hide();

    var pagina = parseInt($('#masCotizaciones').attr('data-pagina'));
    var proxima_pagina = pagina + 1;

    //console.log('Di click en masAnuncios');   

    $.get('ajaxphp/mascotizaciones.php','page='+ proxima_pagina, function(data){
        console.log(data);
...
$('#masCotizaciones').click(masAnuncios);
