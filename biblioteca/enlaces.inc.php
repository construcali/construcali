    ...
    <div class="container content profile">
        <div class="row">
            ...
            <div class="col-md-3 magazine-page">
                ...
                <form method="post" action="biblioteca.php?content=buscar">
                            ...
                            <div class="row">
                                ...
                                <?php
                                    foreach ($categorias as $key => $value) {
                                         echo "<li><a href=\"biblioteca.php?content=estosenlaces&catid=$key\"><i class=\"fa fa-tags\"></i>$value</a></li>";
                                     } 
                                ?>      
                                </ul>
                            </div>                       
                        ...
                        <div id="home-2" class="tab-pane magazine-sb-categories">
                            <div class="row">
                                <ul class="list-unstyled col-xs-6">
                                    <li><a target="_blank" href="https://docs.google.com/spreadsheets/d/1zeGXD6C9-Nolj2sIqVyO-QGv_zKnwg7PvHhK4xKNo4E/edit#gid=0">Lista Excel</a></li>
                                ...
                                <ul class="list-unstyled col-xs-6">
                                    <li><a target="_blank" href="https://docs.google.com/spreadsheets/d/1zeGXD6C9-Nolj2sIqVyO-QGv_zKnwg7PvHhK4xKNo4E/edit#gid=0">Grupo Whatsapp</a></li>
                        ...
                        <div class="text-center">
                            ...
                            <?php
                             if ($thispage > 1)
                                {
                                    $page = $thispage - 1 ;
                                    $prevpage = "<li class=\"active\"><a href=\"biblioteca.php?content=enlaces&page=$page\">Anterior</a></li>";
                                }
                                else
                                {
                            ...
                            if ($totpages >1)
                                {
                                    ...
                                    for($page = 1; $page <= $totpages; $page++)
                                    {
                                        ...
                                        {
                                            $bar .= "<li><a href=\"biblioteca.php?content=enlaces&page=$page\">$page</a></li>";
                                        }
                                    }
                                }
                            ...
                            if ($thispage < $totpages)
                             {
                                $page = $thispage + 1;
                                $nextpage = "<li><a href=\"biblioteca.php?content=enlaces&page=$page\">Proxima</a></li>"; 
                             }else
                             {
