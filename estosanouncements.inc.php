<!--=== Breadcrumbs ===-->
    <div class="breadcrumbs">
        <div class="container">
            ...
            <ul class="pull-right breadcrumb">
                ...
                {
                    echo "<li class=\"active\"><a href=\"cotizaciones.php?content=anunciar\">Anunciese Gratis</a></li>";
                }
            ?>
    ...
    <div class="container s-results margin-bottom-50">
        <div class="row">
            ...
            <div class="col-md-10">
                <span class="results-number">Se requieren estos servicios</span>
                <!-- Begin Inner Results -->
                <?php 
                ...
                ?>
                <div class="inner-results" id="servicio<?php echo $productoid; ?>">
                    ...
                    <ul class="list-inline down-ul">
                        ...
                        <?php echo "<li><a href=\"cotizaciones.php?content=unanouncement&id=$productoid\">Responder</a></li>"; ?>
                    </ul>    
                </div>
                <hr>
                <?php
