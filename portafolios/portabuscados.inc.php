            ...
            <div class="col-md-9 col-sm-12">
                <div class="panel panel-green margin-bottom-40">
                        ...
                        <table class="table">
                            ...
                            $categoria = $portaenlace['categoria'];
                            ?>
                                <tr>
                                    <td><?php echo "<a href=\"$url\" target=\"_blank\">$empresa</a>"; ?>
                                    </td>
                                    <td>
                                        <span class="item-box">
                                            <span class="item">
                                                <?php echo "<a href=\"http://construcali.com/empresas.php?content=estaempresa&id=$empresaid\" target=\"_blank\">"; ?>Perfil Empresarial</a>
                                            </span>
                                        </span>
                                    </td>
                                    <td>
