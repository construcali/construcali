            ...
            <div class="col-md-9 col-sm-12">
                <div class="panel panel-green margin-bottom-40">
                        ...
                        <table class="table">
                            ...
                            $url = $portaenlace['url'];
                            $empresa = $portaenlace['empresa'];
                            $empresa =htmlentities($empresa);
                            ?>
                                <tr>
                                    <td>
                                        <?php echo "<a href=\"http://construcali.com/empresas.php?content=estaempresa&id=$empresaid\" target=\"_blank\">".$empresa."</a>"; ?>
                                    ...
                                    <!-- <td>
                                        <span class="label label-warning"><?php echo $categoria; ?></span>
                                    </td>
                                    -->                          
                                </tr>
                            <?php
                        ...
                        <div class="text-center">
                            ...
                            <?php
                             if ($estapagina > 1)
                                {
                                    $page = $estapagina - 1 ;
                                    $prevpage = "<li class=\"active\"><a href=\"portafolios.php?content=estosportafolio&catid=$catid&pagina=$page\">Anterior</a></li>";
                                }
                                else
                                {
                            ...
                            if ($totpaginas >1)
                                {
                                    ...
                                    for($page = 1; $page <= $totpaginas; $page++)
                                    {
                                        ...
                                        {
                                            $bar .= "<li><a href=\"portafolios.php?content=estosportafolios&catid=$catid&pagina=$page\">$page</a></li>";
                                        }
                                    }
                                }
                            ...
                            if ($thispage < $totpaginas)
                             {
                                $page = $estapagina + 1;
                                $nextpage = "<li><a href=\"portafolios.php?content=estosportafolios&catid=$catid&pagina=$page\">Proxima</a></li>"; 
                             }else
                             {
