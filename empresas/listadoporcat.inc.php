    	...
    	<div class="row">
        	<div class="col-md-9">
                ...
                <?php if ($cuantas_empresas == 0){
                    $mensaje_resultado = '<h2>No se encontro empresas en '.$cat_titulo.'</h2>';
                    echo $mensaje_resultado;
                 }else{
                    echo "<h2>Empresas en la categoria de ".$cat_titulo."</h2>";
                 } 
                 ?>
                </div>
                ...
                if (isset($companies)){
                    ...
                    echo "<div class=\"row clients-page\">";
                        ...
                        echo "<div class=\"col-md-10\">";
                            echo "<h3><a href=\"empresas.php?content=estaempresa&id=$empresaid\">".htmlentities(trim($compania['empresa']))."</a></h3>";
                        ...
                        if (($url != 'http://'))
                                ...
                                echo "<li><i class=\"fa fa-whatsapp color-green\"></i>".$whatsapp."</li>";
                ...
                <?php
                    ...
                    {
                        $page = $thispage - 1 ;
                        $prevpage = "<li><a href=\"empresas.php?content=categorias&id=$catid&page=$page\">Atras</a></li";
                    }
                    else
                    {
                ...
                if ($totpages >1)
                    {
                        ...
                        for($page = 1; $page <= $totpages; $page++)
                        {
                            ...
                            {
                                $bar .= "<li><a href=\"empresas.php?content=categorias&id=$catid&page=$page\">$page</a></li>";
                            }
                        }
                    }
                ...
                if ($thispage < $totpages)
                 {
                    $page = $thispage + 1;
                    $nextpage = "<li><a href=\"empresas.php?content=categorias&id=$catid&page=$page\">Adelante</a></li>"; 
                 }else
                 {
