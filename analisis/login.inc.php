<!-- Este login.inc.php va a analisis.php?content=verificar -->
...
<!--=== Profile ===-->
    <div class="container content profile"> 
        <div class="row">
            ...
            <!-- Profile Content -->
            <div class="col-md-6">
                        <form action="analisis.php?content=verificar" method="post" id="sky-form2" class="sky-form">
                            <header><?php echo (isset($mensaje)) ? $mensaje : 'Ingrese a Construcali.com'; ?> </header>
                                ...
                                <section>
                                    <div class="row" id="password1">
                                        ...
                                        <div class="col col-8">
                                            ...
                                            <button type="submit" class="btn-u">Acceder</button>
                                        </div>
                                    </div>
                                </section>
